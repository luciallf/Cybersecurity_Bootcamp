...
urls_webs = set()  # Conjunto para almacenar las URLs de las páginas web
urls_imag = set()  # Conjunto para almacenar las URLs de las imágenes

def extraer_url(sitioweb, niv):
    """
    Esta función extrae las URLs de las páginas web dentro del sitio web dado.
    Recursivamente se llama a sí misma para seguir extrayendo URLs hasta alcanzar el nivel máximo de profundidad.
    """
    try:
...
def descargar_imagen(contains):
    """
    Esta función descarga las imágenes encontradas en las URLs de las páginas web.
    """
...
if __name__ == "__main__":
    ...
    analizador.add_argument("URL", help="URL del sitio web donde se quieren descargar las imágenes")
    ...
    analizador.add_argument("-l", help="indica el nivel de profundidad máximo de la descarga recursiva", type=int, default=5)
